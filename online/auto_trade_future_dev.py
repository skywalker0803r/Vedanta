...
def send_telegram_message(message):
    if not TELEGRAM_TOKEN or not TELEGRAM_CHAT_ID:
        print("Telegram token or chat ID not set. Skipping Telegram message.")
        return
    ...
    try:
        ...
        # print(response.text) # Don't print response to avoid infinite loop if sys.stdout is redirected
